...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Ticket', fields ['conference', 'code']
        db.create_unique('conference_ticket', ['conference', 'code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Ticket', fields ['conference', 'code']
        db.delete_unique('conference_ticket', ['conference', 'code'])
