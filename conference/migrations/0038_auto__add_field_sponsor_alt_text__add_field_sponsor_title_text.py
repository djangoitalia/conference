...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sponsor.alt_text'
        db.add_column('conference_sponsor', 'alt_text', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Sponsor.title_text'
        db.add_column('conference_sponsor', 'title_text', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sponsor.alt_text'
        db.delete_column('conference_sponsor', 'alt_text')

        # Deleting field 'Sponsor.title_text'
        db.delete_column('conference_sponsor', 'title_text')
