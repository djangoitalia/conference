...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Track.outdoor'
        db.add_column('conference_track', 'outdoor', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Track.outdoor'
        db.delete_column('conference_track', 'outdoor')
