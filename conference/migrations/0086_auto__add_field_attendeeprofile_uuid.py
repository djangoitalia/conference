...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AttendeeProfile.uuid'
        db.add_column('conference_attendeeprofile', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=6, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AttendeeProfile.uuid'
        db.delete_column('conference_attendeeprofile', 'uuid')
    ...
    models = {
        ...
        'conference.attendeeprofile': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '6', 'unique': 'True', 'null': 'True'}),
