...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_conferencetag', (
            ('taggeditem_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['taggit.TaggedItem'], unique=True, primary_key=True)),
        ))
    ...
    models = {
        ...
        'conference.conferencetag': {
            'Meta': {'object_name': 'ConferenceTag', '_ormbases': ['taggit.TaggedItem']},
            'taggeditem_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['taggit.TaggedItem']", 'unique': 'True', 'primary_key': 'True'})
        },
        'conference.deadline': {
