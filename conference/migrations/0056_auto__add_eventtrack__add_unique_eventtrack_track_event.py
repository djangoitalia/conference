...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_eventtrack', (
        ...
        db.send_create_signal('conference', ['EventTrack'])

        # Adding unique constraint on 'EventTrack', fields ['track', 'event']
        db.create_unique('conference_eventtrack', ['track_id', 'event_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'EventTrack', fields ['track', 'event']
        db.delete_unique('conference_eventtrack', ['track_id', 'event_id'])

        # Deleting model 'EventTrack'
        db.delete_table('conference_eventtrack')
