...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conference.conference_start'
        db.add_column('conference_conference', 'conference_start', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Conference.conference_end'
        db.add_column('conference_conference', 'conference_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Conference.conference_start'
        db.delete_column('conference_conference', 'conference_start')

        # Deleting field 'Conference.conference_end'
        db.delete_column('conference_conference', 'conference_end')
