...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_attendee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Ticket'])),
        ))
        db.send_create_signal('conference', ['Attendee'])


    def backwards(self, orm):
        
        # Deleting model 'Attendee'
        db.delete_table('conference_attendee')
