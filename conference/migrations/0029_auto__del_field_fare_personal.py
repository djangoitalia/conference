...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Fare.personal'
        db.delete_column('conference_fare', 'personal')


    def backwards(self, orm):
        
        # Adding field 'Fare.personal'
        db.add_column('conference_fare', 'personal', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
