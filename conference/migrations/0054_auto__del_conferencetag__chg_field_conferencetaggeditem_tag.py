...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('conference_conferencetag')

        # Changing field 'ConferenceTaggedItem.tag'
        db.alter_column('conference_conferencetaggeditem', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taggit.Tag']))


    def backwards(self, orm):
        
        # Adding model 'ConferenceTag'
        db.create_table('conference_conferencetag', (
            ('tag_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['taggit.Tag'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('conference', ['ConferenceTag'])

        # Changing field 'ConferenceTaggedItem.tag'
        db.alter_column('conference_conferencetaggeditem', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.ConferenceTag']))
    ...
    models = {
        ...
        'conference.conferencetaggeditem': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'conference_conferencetaggeditem_items'", 'to': "orm['taggit.Tag']"})
        },
        'conference.deadline': {
