...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'MultilingualContent', fields ['object_id']
        db.create_index('conference_multilingualcontent', ['object_id'])


    def backwards(self, orm):
        
        # Removing index on 'MultilingualContent', fields ['object_id']
        db.delete_index('conference_multilingualcontent', ['object_id'])
