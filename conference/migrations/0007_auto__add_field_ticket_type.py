...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('conference_ticket', 'type', self.gf('django.db.models.fields.CharField')(default='conference', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.type'
        db.delete_column('conference_ticket', 'type')
