...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttendeeProfile.user'
        db.alter_column('conference_attendeeprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AttendeeProfile.id'
        raise RuntimeError("Cannot reverse this migration. 'AttendeeProfile.id' and its values cannot be restored.")

        # Changing field 'AttendeeProfile.user'
        db.alter_column('conference_attendeeprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
