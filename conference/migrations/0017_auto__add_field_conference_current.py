...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conference.current'
        db.add_column('conference_conference', 'current', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Conference.current'
        db.delete_column('conference_conference', 'current')
