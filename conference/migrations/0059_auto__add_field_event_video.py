...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.video'
        db.add_column('conference_event', 'video', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.video'
        db.delete_column('conference_event', 'video')
