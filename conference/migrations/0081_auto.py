...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Fare', fields ['ticket_type']
        db.create_index('conference_fare', ['ticket_type'])


    def backwards(self, orm):
        
        # Removing index on 'Fare', fields ['ticket_type']
        db.delete_index('conference_fare', ['ticket_type'])
