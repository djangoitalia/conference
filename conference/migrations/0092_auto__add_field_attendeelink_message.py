...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AttendeeLink.message'
        db.add_column('conference_attendeelink', 'message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AttendeeLink.message'
        db.delete_column('conference_attendeelink', 'message')
    ...
    models = {
        ...
        'conference.attendeelink': {
            'Meta': {'object_name': 'AttendeeLink'},
            'attendee1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'link1'", 'to': "orm['conference.AttendeeProfile']"}),
            'attendee2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'link2'", 'to': "orm['conference.AttendeeProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'conference.presence': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'presences'", 'to': "orm['conference.AttendeeProfile']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        'conference.quote': {
