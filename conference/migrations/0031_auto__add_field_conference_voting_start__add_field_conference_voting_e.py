...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conference.voting_start'
        db.add_column('conference_conference', 'voting_start', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Conference.voting_end'
        db.add_column('conference_conference', 'voting_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Conference.voting_start'
        db.delete_column('conference_conference', 'voting_start')

        # Deleting field 'Conference.voting_end'
        db.delete_column('conference_conference', 'voting_end')
    ...
    models = {
        ...
        'conference.vototalk': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'vote': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
