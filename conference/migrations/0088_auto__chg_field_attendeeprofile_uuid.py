...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttendeeProfile.uuid'
        db.alter_column('conference_attendeeprofile', 'uuid', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=6))


    def backwards(self, orm):
        
        # Changing field 'AttendeeProfile.uuid'
        db.alter_column('conference_attendeeprofile', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=6, null=True))
