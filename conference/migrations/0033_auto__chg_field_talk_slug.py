...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('conference_talk', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Talk.slug'
        db.alter_column('conference_talk', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
