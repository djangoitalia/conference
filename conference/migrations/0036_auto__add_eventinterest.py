...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_eventinterest', (
        ...
        db.send_create_signal('conference', ['EventInterest'])


    def backwards(self, orm):
        
        # Deleting model 'EventInterest'
        db.delete_table('conference_eventinterest')
    ...
    models = {
        ...
        'conference.eventinterest': {
            'Meta': {'object_name': 'EventInterest'},
