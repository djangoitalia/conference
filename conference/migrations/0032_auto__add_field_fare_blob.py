...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fare.blob'
        db.add_column('conference_fare', 'blob', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fare.blob'
        db.delete_column('conference_fare', 'blob')
