...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('conference_talk', 'level', self.gf('django.db.models.fields.CharField')(default='beginner', max_length=12), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.level'
        db.delete_column('conference_talk', 'level')
