...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.teaser_video'
        db.add_column('conference_talk', 'teaser_video', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.teaser_video'
        db.delete_column('conference_talk', 'teaser_video')
