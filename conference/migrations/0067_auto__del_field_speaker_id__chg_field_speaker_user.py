...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Speaker.id'
        db.delete_column('conference_speaker', 'id')

        # Changing field 'Speaker.user'
        db.alter_column('conference_speaker', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Speaker.id'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.id' and its values cannot be restored.")

        # Changing field 'Speaker.user'
        db.alter_column('conference_speaker', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
