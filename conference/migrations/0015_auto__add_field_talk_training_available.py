...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.training_available'
        db.add_column('conference_talk', 'training_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.training_available'
        db.delete_column('conference_talk', 'training_available')
