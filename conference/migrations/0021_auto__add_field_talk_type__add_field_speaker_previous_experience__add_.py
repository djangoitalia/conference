...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.type'
        db.add_column('conference_talk', 'type', self.gf('django.db.models.fields.CharField')(default='s', max_length=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Talk.type'
        db.delete_column('conference_talk', 'type')
