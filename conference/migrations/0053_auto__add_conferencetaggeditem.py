...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_conferencetaggeditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conference_conferencetaggeditem_tagged_items', to=orm['contenttypes.ContentType'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conference_conferencetaggeditem_items', to=orm['conference.ConferenceTag'])),
        ))
        db.send_create_signal('conference', ['ConferenceTaggedItem'])


    def backwards(self, orm):
        
        # Deleting model 'ConferenceTaggedItem'
        db.delete_table('conference_conferencetaggeditem')
    ...
    models = {
        ...
        'conference.conferencetag': {
            'Meta': {'object_name': 'ConferenceTag', '_ormbases': ['taggit.Tag']},
