...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.frozen'
        db.add_column('conference_ticket', 'frozen', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.frozen'
        db.delete_column('conference_ticket', 'frozen')
