...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.promo_video_url'
        db.add_column('conference_talk', 'promo_video_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.promo_video_url'
        db.delete_column('conference_talk', 'promo_video_url')
