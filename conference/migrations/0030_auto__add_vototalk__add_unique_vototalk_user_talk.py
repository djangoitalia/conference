...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_vototalk', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('talk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conference.Talk'])),
            ('vote', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('conference', ['VotoTalk'])

        # Adding unique constraint on 'VotoTalk', fields ['user', 'talk']
        db.create_unique('conference_vototalk', ['user_id', 'talk_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'VotoTalk', fields ['user', 'talk']
        db.delete_unique('conference_vototalk', ['user_id', 'talk_id'])

        # Deleting model 'VotoTalk'
        db.delete_table('conference_vototalk')
