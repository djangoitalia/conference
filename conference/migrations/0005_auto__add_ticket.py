...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ticket'
        db.create_table('conference_ticket', (
            ...
            ('personal', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('conference', ['Ticket'])


    def backwards(self, orm):
        
        # Deleting model 'Ticket'
        db.delete_table('conference_ticket')
