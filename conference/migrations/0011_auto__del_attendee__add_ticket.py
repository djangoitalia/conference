...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('conference_attendee', 'conference_ticket')

    def backwards(self, orm):
        
        db.rename_table('conference_ticket', 'conference_attendee')
    ...
    models = {
        ...
        'conference.ticket': {
            ...
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['conference.Fare']"}),
