...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VotoTalk.vote'
        db.alter_column('conference_vototalk', 'vote', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'VotoTalk.vote'
        db.alter_column('conference_vototalk', 'vote', self.gf('django.db.models.fields.PositiveIntegerField')())
