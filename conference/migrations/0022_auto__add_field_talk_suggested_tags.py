...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.suggested_tags'
        db.add_column('conference_talk', 'suggested_tags', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.suggested_tags'
        db.delete_column('conference_talk', 'suggested_tags')
