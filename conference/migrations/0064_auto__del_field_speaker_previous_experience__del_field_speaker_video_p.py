...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Speaker.previous_experience'
        db.delete_column('conference_speaker', 'previous_experience')

        # Deleting field 'Speaker.video_presentation'
        db.delete_column('conference_speaker', 'video_presentation')

        # Deleting field 'Speaker.name'
        db.delete_column('conference_speaker', 'name')

        # Deleting field 'Speaker.twitter'
        db.delete_column('conference_speaker', 'twitter')

        # Deleting field 'Speaker.last_year_talks'
        db.delete_column('conference_speaker', 'last_year_talks')

        # Deleting field 'Speaker.industry'
        db.delete_column('conference_speaker', 'industry')

        # Deleting field 'Speaker.company'
        db.delete_column('conference_speaker', 'company')

        # Deleting field 'Speaker.max_audience'
        db.delete_column('conference_speaker', 'max_audience')

        # Deleting field 'Speaker.company_homepage'
        db.delete_column('conference_speaker', 'company_homepage')

        # Deleting field 'Speaker.slug'
        db.delete_column('conference_speaker', 'slug')

        # Deleting field 'Speaker.location'
        db.delete_column('conference_speaker', 'location')

        # Deleting field 'Speaker.image'
        db.delete_column('conference_speaker', 'image')

        # Deleting field 'Speaker.activity'
        db.delete_column('conference_speaker', 'activity')

        # Deleting field 'Speaker.homepage'
        db.delete_column('conference_speaker', 'homepage')

        # Deleting field 'Speaker.activity_homepage'
        db.delete_column('conference_speaker', 'activity_homepage')

        # Adding unique constraint on 'AttendeeProfile', fields ['slug']
        db.create_unique('conference_attendeeprofile', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AttendeeProfile', fields ['slug']
        db.delete_unique('conference_attendeeprofile', ['slug'])

        # Adding field 'Speaker.previous_experience'
        db.add_column('conference_speaker', 'previous_experience', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Speaker.video_presentation'
        db.add_column('conference_speaker', 'video_presentation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Speaker.name'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.name' and its values cannot be restored.")

        # Adding field 'Speaker.twitter'
        db.add_column('conference_speaker', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)

        # Adding field 'Speaker.last_year_talks'
        db.add_column('conference_speaker', 'last_year_talks', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Speaker.industry'
        db.add_column('conference_speaker', 'industry', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Speaker.company'
        db.add_column('conference_speaker', 'company', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Speaker.max_audience'
        db.add_column('conference_speaker', 'max_audience', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Speaker.company_homepage'
        db.add_column('conference_speaker', 'company_homepage', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Speaker.slug'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.slug' and its values cannot be restored.")

        # Adding field 'Speaker.location'
        db.add_column('conference_speaker', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Speaker.image'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.image' and its values cannot be restored.")

        # Adding field 'Speaker.activity'
        db.add_column('conference_speaker', 'activity', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Speaker.homepage'
        db.add_column('conference_speaker', 'homepage', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Speaker.activity_homepage'
        db.add_column('conference_speaker', 'activity_homepage', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
