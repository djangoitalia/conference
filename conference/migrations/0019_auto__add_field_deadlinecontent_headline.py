...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeadlineContent.headline'
        db.add_column('conference_deadlinecontent', 'headline', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeadlineContent.headline'
        db.delete_column('conference_deadlinecontent', 'headline')
