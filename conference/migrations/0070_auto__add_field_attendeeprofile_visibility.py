...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AttendeeProfile.visibility'
        db.add_column('conference_attendeeprofile', 'visibility', self.gf('django.db.models.fields.CharField')(default='x', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AttendeeProfile.visibility'
        db.delete_column('conference_attendeeprofile', 'visibility')
