...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Speaker.user'
        db.add_column('conference_speaker', 'user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Speaker.user'
        db.delete_column('conference_speaker', 'user_id')
