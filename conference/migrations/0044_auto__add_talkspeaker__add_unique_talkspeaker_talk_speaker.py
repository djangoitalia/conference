...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_talkspeaker', (
        ...
        db.send_create_signal('conference', ['TalkSpeaker'])

        # Adding unique constraint on 'TalkSpeaker', fields ['talk', 'speaker']
        db.create_unique('conference_talkspeaker', ['talk_id', 'speaker_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TalkSpeaker', fields ['talk', 'speaker']
        db.delete_unique('conference_talkspeaker', ['talk_id', 'speaker_id'])

        # Deleting model 'TalkSpeaker'
        db.delete_table('conference_talkspeaker')
