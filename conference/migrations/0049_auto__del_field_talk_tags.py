...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Talk.tags'
        db.delete_column('conference_talk', 'tags')


    def backwards(self, orm):
        
        # Adding field 'Talk.tags'
        db.add_column('conference_talk', 'tags', self.gf('django.db.models.fields.CharField')(max_length=400, default=''), keep_default=False)
