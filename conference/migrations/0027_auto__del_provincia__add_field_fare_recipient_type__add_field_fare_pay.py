...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('conference_provincia')

        # Adding field 'Fare.recipient_type'
        db.add_column('conference_fare', 'recipient_type', self.gf('django.db.models.fields.CharField')(default='p', max_length=1), keep_default=False)

        # Adding field 'Fare.payment_type'
        db.add_column('conference_fare', 'payment_type', self.gf('django.db.models.fields.CharField')(default='p', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'Provincia'
        db.create_table('conference_provincia', (
            ('fine_cap_comuni', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('sigla', self.gf('django.db.models.fields.CharField')(unique=True, max_length=2, null=True)),
            ('regione', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('inizio_cap_capologuo', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('inizio_cap_comuni', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('fine_cap_capologuo', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('conference', ['Provincia'])

        # Deleting field 'Fare.recipient_type'
        db.delete_column('conference_fare', 'recipient_type')

        # Deleting field 'Fare.payment_type'
        db.delete_column('conference_fare', 'payment_type')
    ...
    models = {
        ...
        'conference.speaker': {
            ...
            'last_year_talks': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'max_audience': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'previous_experience': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
            'twitter': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'null': 'True'}),
            'video_presentation': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
