...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConferenceTag.category'
        db.add_column('conference_conferencetag', 'category', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConferenceTag.category'
        db.delete_column('conference_conferencetag', 'category')
