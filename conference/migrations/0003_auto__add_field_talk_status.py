...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.status'
        db.add_column('conference_talk', 'status', self.gf('django.db.models.fields.CharField')(default='accepted', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.status'
        db.delete_column('conference_talk', 'status')
