...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.created'
        db.add_column('conference_talk', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 2, 20, 8, 39, 6, 494453), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Talk.created'
        db.delete_column('conference_talk', 'created')
