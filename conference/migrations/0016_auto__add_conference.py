...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('conference_conference', (
            ...
            ('cfp_start', self.gf('django.db.models.fields.DateField')(null=True)),
            ('cfp_end', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
    ...
    models = {
        ...
        'conference.conference': {
            ...
            'cfp_end': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'cfp_start': ('django.db.models.fields.DateField', [], {'null': 'True'}),
