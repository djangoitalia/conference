...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AttendeeProfile.twitter'
        db.delete_column('conference_attendeeprofile', 'twitter')


    def backwards(self, orm):
        
        # Adding field 'AttendeeProfile.twitter'
        db.add_column('conference_attendeeprofile', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)
