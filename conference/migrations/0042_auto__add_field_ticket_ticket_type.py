...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.ticket_type'
        db.add_column('conference_ticket', 'ticket_type', self.gf('django.db.models.fields.CharField')(default='standard', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.ticket_type'
        db.delete_column('conference_ticket', 'ticket_type')
